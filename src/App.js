        ...
        <div className="movie_card">
            <div className="info_section">
                <div className="movie_header">
                    ...
                    <span className="minutes">{imdbRating}/10</span>
                ...
                <div className="movie_desc">
                    ...
                    <ul>
                        <li><a href={"https://www.imdb.com/title/" + imdbID + "/"}><img  width="70px" height="40px" src="https://m.media-amazon.com/images/G/01/IMDb/BG_rectangle._CB1509060989_SY230_SX307_AL_.png" /></a></li>
                        {/* <li><a href={"https://upflix.pl/film/zobacz/" + Title.replace(/\s+/g, '-').replace(':','') + "-" + Released.substr(-4)}><img  width="80px" height="30px" src="https://assets.upflix.pl/dist/img/logo.png" /></a></li> */}
                    </ul>
                </div>
                </div>
